              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-text-muted">
                    Full-width banner slides on the homepage hero section
                  </p>
                </div>
              ...
              {heroSlides.length === 0 ? (
                <Card>
                  <CardBody className="py-12 text-center">
                    ...
                    />
                    <p className="text-sm text-text-muted">
                      No hero slides yet. Add your first banner slide.
                    </p>
                    <Button
                      variant="outline"
                    ...
                    <div className="flex items-center gap-4 px-5 py-3 bg-gray-50/80 border-b border-border">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-text-muted truncate">
                          {slide.overline || "No overline"}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() =>
                            updateHeroSlide(i, { active: !slide.active })
                          }
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-text-muted">
                    Small icons with text shown below the hero section
                  </p>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-text-muted">
                    Promotional banners placed throughout the homepage
                  </p>
                </div>
                ...
                promoBanners.map((banner, i) => (
                  <Card key={banner.id} className="overflow-hidden">
                    <div className="flex items-center gap-4 px-5 py-3 bg-gray-50/80 border-b border-border">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-foreground truncate">
                          {banner.title || `Banner ${i + 1}`}
                        </p>
                      </div>
                      <div className="flex items-center gap-2">
                        <button
                          onClick={() =>
                            updatePromoBanner(i, { active: !banner.active })
                          }
                          className={`p-1.5 rounded-lg transition-colors ${
                            banner.active
                              ? "text-success hover:bg-success/10"
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-text-muted">
                    Numbers and labels that build customer confidence
                  </p>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-text-muted">
                    Trusted brand logos displayed on the homepage
                  </p>
                </div>
                      ...
                      <CardBody>
                        <div className="flex items-start justify-between mb-4">
                          ...
                          <div className="flex items-center gap-1">
                            <button
                              onClick={() =>
                                updateBrandLogo(i, { active: !logo.active })
                              }
                              className={`p-1.5 rounded-lg transition-colors ${
                                logo.active
                                  ? "text-success hover:bg-success/10"
