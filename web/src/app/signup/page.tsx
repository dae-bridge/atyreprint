        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/30 to-transparent flex flex-col justify-end p-16 text-white text-left">
          ...
          <div className="max-w-md">
            ...
            <p className="text-white/80 text-lg font-medium">
              Join thousands of creators, businesses, and fashion enthusiasts
              customising premium apparel and accessories.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-start mt-2">
              ...
              <label
                htmlFor="terms"
                className="ml-3 block text-[13px] text-text-muted leading-relaxed"
              >
                I agree to the{" "}
                <Link
                  href="/terms"
                  className="text-foreground font-semibold hover:text-accent underline"
                >
                  Terms of Service
                </Link>{" "}
                and{" "}
