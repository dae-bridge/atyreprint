    ...
    <div className="flex min-h-screen bg-white font-jost items-center justify-center p-8 sm:p-12 lg:p-24 overflow-y-auto">
      <div className="w-full max-w-md mx-auto text-center">
         ...
         <div className="mb-12">
          ...
          {!submitted ? (
            <>
              ...
              <form className="space-y-6 text-left" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                ...
                <button
                  type="submit"
                  className="w-full h-[54px] bg-primary text-white flex items-center justify-center font-bold text-[14px] tracking-widest uppercase hover:bg-black transition-colors rounded shadow-md"
                >
                  Send Reset Link
                </button>
              </form>
            ...
            <div className="animate-in fade-in duration-500">
              ...
              <button
                ...
                className="w-full h-[54px] border-2 border-primary text-primary font-bold text-[14px] tracking-widest uppercase hover:bg-primary hover:text-white transition-all rounded"
              >
                Resend Link
              </button>
            </div>
          ...
          <div className="mt-10">
            <Link href="/login" className="inline-flex items-center gap-2 text-[14px] font-bold text-text-muted hover:text-accent transition-colors uppercase tracking-widest">
